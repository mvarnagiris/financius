...
public class Calculator {
    ...
    @Inject public Calculator(@ApplicationContext Context context) {
    ...
    private static class OperatorPart extends Part {
        ...
        @Override public Action getAction(Type type, int partIndex, String value) {
            switch (type) {
                case OPERATOR:
        ...
        @Override public CharSequence toFormattedString() {
    ...
    private static class NumberPart extends Part {
        ...
        @Override public NumberPart append(String value) {
