...
public class CsvDataExporter extends DataExporter {
    ...
    private void writeCsv(BufferedWriter writer, Cursor cursor) throws IOException {
        ...
        do {
            ...
            outputLine.append(QUOTE)
                    .append(DateUtils.formatDateTime(context, dateTime, DateUtils.FORMAT_SHOW_DATE | DateUtils.FORMAT_SHOW_YEAR))
                    .append(QUOTE);
            outputLine.append(SEPARATOR)
                    .append(QUOTE)
                    .append(DateUtils.formatDateTime(context, dateTime, DateUtils.FORMAT_SHOW_TIME))
                    .append(QUOTE);
    ...
    private String getCurrencyCode(Transaction transaction) {
        ...
        return account != null ? account.getCurrencyCode() : "";
    }
}
