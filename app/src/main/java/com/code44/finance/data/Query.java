...
public class Query {
    ...
    private static String getSortOrderWithLimit(Query query) {
        ...
        if (limit >= 0) {
            sortOrder = Strings.isNullOrEmpty(sortOrder) ? "1" : sortOrder + " limit " + limit;
        }
        return sortOrder;
    }
    ...
    public static class ContentProviderQuery {
        ...
        public Cursor execute() {
            return context.getContentResolver()
                    .query(uri, query.getProjection(), getSelectionWithGroupBy(query), query.getSelectionArgs(), query.getSortOrder());
        }
    }
