...
public class DBHelper extends SQLiteOpenHelper {
    ...
    @Inject public DBHelper(@ApplicationContext Context context, CurrenciesManager currenciesManager) {
    ...
    public void clear() {
        ...
        database.delete(Tables.ExchangeRates.TABLE_NAME, null, null);
    ...
    public void addDefaults() {
        addDefaults(getWritableDatabase(), currenciesManager);
    }
