...
public final class Tables {
    ...
    public static final class ExchangeRates {
        ...
        public static Query getQuery() {
            return Query.create().projectionLocalId(ExchangeRates.LOCAL_ID).projection(ExchangeRates.PROJECTION);
        }
    }
    ...
    public static final class CurrencyFormats {
        ...
        public static final String[] PROJECTION = {ID.getName(), MODEL_STATE.getName(), SYNC_STATE.getName(), CODE.getName(),
                                                   SYMBOL.getName(), SYMBOL_POSITION.getName(), DECIMAL_SEPARATOR.getName(),
        ...
        public static String createScript() {
            return makeCreateScript(TABLE_NAME, LOCAL_ID, ID, MODEL_STATE, SYNC_STATE, CODE, SYMBOL, SYMBOL_POSITION, DECIMAL_SEPARATOR, GROUP_SEPARATOR, DECIMAL_COUNT);
        }
    ...
    public static final class Accounts {
        ...
        public static final String[] PROJECTION = {ID.getName(), MODEL_STATE.getName(), SYNC_STATE.getName(), CURRENCY_CODE.getName(),
                                                   TITLE.getName(), NOTE.getName(), BALANCE.getName(), INCLUDE_IN_TOTALS.getName()};

        public static final String[] PROJECTION_ACCOUNT_FROM = {ID.getNameWithAs(TEMP_TABLE_NAME_FROM_ACCOUNT),
                                                                MODEL_STATE.getNameWithAs(TEMP_TABLE_NAME_FROM_ACCOUNT),
                                                                SYNC_STATE.getNameWithAs(TEMP_TABLE_NAME_FROM_ACCOUNT),
                                                                CURRENCY_CODE.getNameWithAs(TEMP_TABLE_NAME_FROM_ACCOUNT),
                                                                TITLE.getNameWithAs(TEMP_TABLE_NAME_FROM_ACCOUNT),
                                                                NOTE.getNameWithAs(TEMP_TABLE_NAME_FROM_ACCOUNT),
                                                                BALANCE.getNameWithAs(TEMP_TABLE_NAME_FROM_ACCOUNT),
                                                                INCLUDE_IN_TOTALS.getNameWithAs(TEMP_TABLE_NAME_FROM_ACCOUNT)};

        public static final String[] PROJECTION_ACCOUNT_TO = {ID.getNameWithAs(TEMP_TABLE_NAME_TO_ACCOUNT),
                                                              MODEL_STATE.getNameWithAs(TEMP_TABLE_NAME_TO_ACCOUNT),
                                                              SYNC_STATE.getNameWithAs(TEMP_TABLE_NAME_TO_ACCOUNT),
                                                              CURRENCY_CODE.getNameWithAs(TEMP_TABLE_NAME_TO_ACCOUNT),
                                                              TITLE.getNameWithAs(TEMP_TABLE_NAME_TO_ACCOUNT),
                                                              NOTE.getNameWithAs(TEMP_TABLE_NAME_TO_ACCOUNT),
                                                              BALANCE.getNameWithAs(TEMP_TABLE_NAME_TO_ACCOUNT),
                                                              INCLUDE_IN_TOTALS.getNameWithAs(TEMP_TABLE_NAME_TO_ACCOUNT)};
    ...
    public static final class Categories {
        ...
        public static final String[] PROJECTION = {ID.getName(), MODEL_STATE.getName(), SYNC_STATE.getName(), TRANSACTION_TYPE.getName(),
                                                   TITLE.getName(), COLOR.getName(), SORT_ORDER.getName()};
    ...
    public static final class Tags {
        ...
        public static final String[] PROJECTION = {ID.getName(), MODEL_STATE.getName(), SYNC_STATE.getName(), TITLE.getName()};
    ...
    public static final class Transactions {
        ...
        public static final String[] PROJECTION = {ID.getName(), MODEL_STATE.getName(), SYNC_STATE.getName(), ACCOUNT_FROM_ID.getName(),
                                                   ACCOUNT_TO_ID.getName(), CATEGORY_ID.getName(), DATE.getName(), AMOUNT.getName(),
                                                   EXCHANGE_RATE.getName(), NOTE.getName(), STATE.getName(), TYPE.getName(),
        ...
        public static String createScript() {
            return makeCreateScript(TABLE_NAME, LOCAL_ID, ID, MODEL_STATE, SYNC_STATE, ACCOUNT_FROM_ID, ACCOUNT_TO_ID, CATEGORY_ID, DATE, AMOUNT, EXCHANGE_RATE, NOTE, STATE, TYPE, INCLUDE_IN_REPORTS);
        }
