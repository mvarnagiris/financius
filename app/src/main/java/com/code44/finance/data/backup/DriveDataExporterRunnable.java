...
public class DriveDataExporterRunnable implements Runnable {
    ...
    private final DriveExportActivity.ExportType exportType;
    private final Context context;
    private final EventBus eventBus;
    private final String fileTitle;

    public DriveDataExporterRunnable(GoogleApiClient googleApiClient, DriveId driveId, DriveExportActivity.ExportType exportType, Context context, EventBus eventBus, String fileTitle) {
    ...
    @Override public void run() {
        ...
        final MetadataChangeSet changeSet = new MetadataChangeSet.Builder().setTitle(fileTitle)
                .setMimeType(exportType.getMimeType())
                .build();
