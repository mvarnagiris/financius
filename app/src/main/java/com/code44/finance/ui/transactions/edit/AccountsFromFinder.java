...
class AccountsFromFinder extends Finder<Account> {
    private final Category category;

    public AccountsFromFinder(@NonNull Context context, @NonNull AutoCompleteInput autoCompleteInput, @Nullable Category category) {
