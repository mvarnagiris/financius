...
public class AccountBalanceChartPresenter extends BalanceChartPresenter implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public AccountBalanceChartPresenter(BalanceChartView balanceChartView, LoaderManager loaderManager) {
        super(balanceChartView);
        this.loaderManager = loaderManager;
    }

    @Override protected AmountGrouper.AmountCalculator getTransactionValidator() {
//        return new AmountGrouper.AmountCalculator() {
