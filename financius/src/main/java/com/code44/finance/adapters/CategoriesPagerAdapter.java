...
public class CategoriesPagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        if (position == 0) {
            return CategoriesFragment.newInstance(CategoriesActivity.MODE_VIEW, Category.Type.EXPENSE);
        } else {
            return CategoriesFragment.newInstance(CategoriesActivity.MODE_VIEW, Category.Type.INCOME);
        }
    }
